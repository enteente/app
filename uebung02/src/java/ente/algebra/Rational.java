...
public class Rational{
	...
	public String toString(){
        Rational r = new Rational(this.fraction()); //fraction Rational number
	...
	public Rational add(final Rational r){
		return new Rational(this).addEq(r);
	}

	public static Rational add(final Rational r1, final Rational r2) {
		return new Rational(r1).addEq(r2);
	}
    ...
    public Rational sub(final Rational r){
        return new Rational(this).subEq(r);
    }

    public static Rational sub(final Rational r1, final Rational r2){
        return new Rational(r1).subEq(r2);
    }
	...
	public Rational mult(final Rational r){
		return new Rational(this).multEq(r);
	}

	public static Rational mult(final Rational r1, final Rational r2){
		return new Rational(r1).multEq(r2);
	}
	...
	public Rational div(final Rational r){
		return new Rational(this).divEq(r);
	}

	public static Rational div(final Rational r1, final Rational r2){
		return new Rational(r1).divEq(r2);
	}
     ...
     *      and divides by that
     *      @param non
     *      @return does not override the object, returns new Rational
     */
    public Rational fraction(){
        ...
        return new Rational(num/tmpnum,denom/tmpnum);
    }
